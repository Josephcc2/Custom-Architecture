...
context = (
    ...
    "a multi-stage collaborative writing pipeline. Over the course of this pipeline, each model "
    "independently drafts a report, reviews and critiques the other two "
...
task = """Write a beginner-friendly, practical guide to starting and maintaining a small vegetable garden, whether in a backyard plot or in containers on a balcony.

The guide should address:
- Which vegetables are easiest and most rewarding for a first-time gardener to grow
- Basic soil, sunlight, and watering needs
- A simple month-by-month plan from planting through harvest
- Common early mistakes and how to avoid them

The guide should draw on general, well-established gardening practice and does not need to cite outside sources — write from a place of clear, practical expertise rather than academic research."""
...
layers = [
    ...
    Layer(
        ...
        prompt=(
            f"{agent_preamble}"
            "Write a thorough, well-organized report addressing the task above, using markdown. "
    ...
    Layer(
        ...
        prompt=(
            ...
            "be well-organized and use markdown. If Claude fails any of these then be sure to note those "
    ...
    Layer(
        ...
        prompt=(
            ...
            "be well-organized and use markdown. If Grok fails any of these then be sure to note those "
            "in addition to your other feedback."
        ),
    ...
    Layer(
        ...
        prompt=(
            ...
            "be well-organized and use markdown. If ChatGPT fails any of these then be sure to note those "
            "in addition to your other feedback."
        ),
    ...
    Layer(
        ...
        prompt=(
            ...
            "The report must be well-organized and use markdown."
        ),
    ...
    Layer(
        ...
        prompt=(
            ...
            "Keep in mind that each report must be well-organized and use markdown. Do not provide "
    ...
    Layer(
        ...
        prompt=(
            ...
            "Do not add conversational filler, preambles, or sign-offs in your final output—only the markdown report.\n"
            "Keep in mind that each report must be well-organized and use markdown. The tone of the report should be "
            "friendly and easy to follow for a general audience. "
            "Do your best to meet in the middle with the other LLMs."
        ),
